    ...
    <div className='bg-gray-200 rounded-lg p-4 flex w-76 justify-center justify-self-center m-32 min-h-76 shadow-2xl text-black'>
      <div className='flex flex-col space-y-4 justify-center items-center'>
        ...
        <div className='flex flex-col space-y-8'>
          ...
          <p className='text-gray-400 text-sm'>Don't have an account? <Link className='text-gray-700 hover:text-gray-950' href={'/Signup'}>Sign up</Link></p>
          <Link href={'/Dashboard'} className='flex justify-center'>
          <button className='bg-blue-500 rounded-lg px-4 py-2 text-amber-50 hover:cursor-pointer hover:bg-blue-950'>Sign in</button>
          </Link>
        </div>
      </div>
    </div>
